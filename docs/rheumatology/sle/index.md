...
## Versions
  ...
  - **ACR / EULAR** — ACR / EULAR SLE Guidelines
    - Read the guideline: [html](https://acrjournals.onlinelibrary.wiley.com/doi/10.1002/acr.25690)
  - **2024 · KDIGO** — [KDIGO 2024 Lupus Nephritis Guideline]({{ '/rheumatology/sle/2024-kdigo/' | relative_url }})
    - Read the guideline: [html](https://kdigo.org/guidelines/lupus-nephritis/) · [<img src="{{ '/assets/anki.png' | relative_url }}" alt="" style="height:1.1em;vertical-align:-0.2em;margin-right:0.25em">Anki deck](https://github.com/cfu288/guidelines-flashcards/raw/main/build/decks/rheumatology/sle/2024-kdigo.apkg)
