...
**Current guideline:** [ACR 2020 Gout Management Guideline]({{ '/rheumatology/gout/2020-acr/' | relative_url }}) · [<img src="{{ '/assets/anki.png' | relative_url }}" alt="" style="height:1.1em;vertical-align:-0.2em;margin-right:0.25em">download Anki sub-deck](https://github.com/cfu288/guidelines-flashcards/raw/main/build/decks/rheumatology/gout/2020-acr.apkg) — safe to import on its own or alongside the full deck. Nothing gets duplicated and any reviews you've already done stay intact.

## Versions

  - **2020 · ACR** — [ACR 2020 Gout Management Guideline]({{ '/rheumatology/gout/2020-acr/' | relative_url }})
    - Read the guideline: [html](https://acrjournals.onlinelibrary.wiley.com/doi/10.1002/acr.24180) · [<img src="{{ '/assets/anki.png' | relative_url }}" alt="" style="height:1.1em;vertical-align:-0.2em;margin-right:0.25em">Anki deck](https://github.com/cfu288/guidelines-flashcards/raw/main/build/decks/rheumatology/gout/2020-acr.apkg)
